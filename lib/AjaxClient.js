...
function createHttpRequest() {
    ...
    var o = {
        fromHttpRequestConfig: function (_a) {
            var url = _a.url, method = _a.method, headers = _a.headers, withCredentials = _a.withCredentials, timeout = _a.timeout, credentials = _a.credentials, body = _a.body;
            _url = url;
            _method = method || 'get';
